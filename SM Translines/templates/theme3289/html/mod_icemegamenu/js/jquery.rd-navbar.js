!(function (e) {
  ...
  (l.prototype = {
      ...
      e("body")
        ...
        .append(
          e("<div/>", { class: a.panelClass })
            .append(
              e("<button/>", { class: a.toggleClass }).append(e("<span/>"))
            )
          ...
          if (n[r].tagName)
            switch (
              (i ||
                ...
                (i.className =
                  l[o].className.indexOf("active") > -1
                    ? "level_1 active"
                    : "level_1")),
    ...
    scroll: function (l) {
      l.preventDefault();
      var o = e("." + a.menuClass),
        n = l.originalEvent.targetTouches
          ? l.originalEvent.targetTouches[0].pageX
          : l.pageX,
        i = l.originalEvent.targetTouches
      ...
      if (
        ...
        l.originalEvent.targetTouches
          ? (t || (t = i), (r = t - i), (t = i), (s = r > 0))
          : (r = -50 * (l.originalEvent.wheelDelta || -l.originalEvent.detail)),
      ...
      if (t.originalEvent) {
        var s = e("." + a.menuClass),
          l = t.originalEvent.targetTouches
            ...
            : t.pageX,
          o = t.originalEvent.targetTouches
        ...
        (o > s.offset().top &&
          ...
          e("." + a.toggleClass).trigger(t.data.type);
      }
    },
    isMobile: function () {
