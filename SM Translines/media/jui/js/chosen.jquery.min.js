  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.set_default_text = function () {
      ...
      this.custom_group_text =
        ...
        this.options.custom_group_text ||
        "Custom Value";
  ...
  Chosen = (function (_super) {
    ...
    Chosen.prototype.set_up_html = function () {
      ...
      if (this.form_field.id.length) {
        container_props.id =
          this.form_field.id.replace(/[^\w]/g, "_") + "_chzn";
      }
      ...
      if (this.is_multiple) {
        ...
        this.container.html(
          '<a class="chzn-single chzn-default"><span>' +
            this.default_text +
    ...
    Chosen.prototype.result_select = function (evt) {
      ...
      if (this.result_highlight) {
        ...
        this.form_field.options[
          this.form_field.options.length - 1
        ].selected = true;
        if (!evt.metaKey) {
          this.results_hide();
        }
    ...
    Chosen.prototype.add_unique_custom_group = function () {
      ...
      if (!group) {
        group = $(
          '<optgroup label="' + this.custom_group_text + '"></optgroup>'
        );
      }
      return $(group);
    };
    ...
    Chosen.prototype.no_results = function (terms) {
      ...
      return this.form_field_jq.trigger("liszt:no_results", { chosen: this });
    };
