/*! For license information please see demo-83704d1ef817db2f2181.js.LICENSE.txt */
(() => {
  "use strict";
  var e,
    t,
    ...
    o = {
      ...
      3724: (e, t, n) => {
        ...
        function f() {
          ...
          o.Z.subscribe(function (t) {
            ...
            fetch(
              (0, i.CN)(
                "".concat(u.Z.apiUrls.collection, "/v2/collections/my"),
                { expand: "items", name: "Favorites" }
              ),
                      ...
                      (function (e, t) {
                        ...
                        o.Z.subscribe(function (e) {
                          ...
                          fetch(
                            ""
                              .concat(
                                u.Z.apiUrls.collection,
                                "/v2/collections/merge/"
                              )
                              .concat(t),
                            {
                              method: "PUT",
          ...
          (e || t) &&
            (!e && t
              ? (function () {
                  ...
                  fetch(
                    (0, i.CN)(
                      "".concat(u.Z.apiUrls.collection, "/v2/collections"),
                      { expand: "items", "ids[]": e }
                    )
                  )
                    .then(function (e) {
        ...
        function b(e) {
          ...
          return (
            (n = new p.Z({
              props: { src: e[7].icon, className: "device-btn-icon" },
            })),
            {
              c() {
                (t = (0, d.bGB)("button")),
                  (0, d.YCL)(n.$$.fragment),
                  (r = (0, d.DhX)()),
                  (0, d.Ljt)(t, "type", "button"),
                  (0, d.Ljt)(
                    t,
                    "class",
                    (o =
                      "device-btn device-btn_" +
                      e[7].name +
                      (e[1] === e[7].name ? " device-btn_active" : ""))
                  ),
                  (0, d.Ljt)(t, "title", (a = e[0][e[7].name]));
              },
              m(e, o) {
                (0, d.$Tr)(e, t, o),
                  (0, d.yef)(n, t, null),
        ...
        function w(e, t, n) {
          ...
          function s(e) {
            n(1, (a = e)),
              ...
              i.classList.add(`${y}_${e}`);
          }
          (0, h.H3)(() => {
            window.matchMedia("(max-width: 959px)").matches &&
              (n(1, (a = "tablet")), s("tablet"));
          });
          return (
            (e.$$set = (e) => {
        ...
        class x extends d.f_C {
          constructor(e) {
            super(), (0, d.S1n)(this, e, w, g, d.N8, { translations: 0 });
          }
        }
        const C = x;
        var k = n(5980),
        ...
        function S(e) {
          !e.target.closest("button") &&
            e.target.closest("a") &&
            (0, k.y)((0, l.c)("productClick", e.currentTarget.dataset));
        }
        (0, i.Fi)(function () {
          document
            .querySelectorAll("[data-product-interaction]")
            .forEach(function (e) {
        ...
        function P(e) {
          let t, n;
          return (
            (t = new j.Z({ props: { width: "fixed", height: "medium" } })),
            {
              c() {
                (0, d.YCL)(t.$$.fragment);
              },
              ...
              c() {
                (t = (0, d.bGB)("button")),
                  ...
                  (0, d.Ljt)(
                    ...
                    "class",
                    (o =
                      "header-btn header-btn_cart " +
                      (e[1] ? "add-to-cart-button-loading btn btn_4" : ""))
                  );
              },
              m(r, o) {
                (0, d.$Tr)(r, t, o),
                  ...
                  i ||
                    ((c = [
                      (0, d.oLt)(Z, "click", e[2]),
                      (0, d.oLt)(t, "click", function () {
                        (0, d.sBU)(e[1] ? A : e[3]) &&
                          (e[1] ? A : e[3]).apply(this, arguments);
                      }),
                    ]),
                    (i = !0));
              },
                    ...
                    (2 & c[0] &&
                      o !==
                        (o =
                          "header-btn header-btn_cart " +
                          (e[1]
                            ? "add-to-cart-button-loading btn btn_4"
                            : "")))) &&
                    (0, d.Ljt)(t, "class", o);
              },
              i(e) {
        ...
        function E(e, t, n) {
          ...
          let { productId: f = null } = t,
            { typeId: v } = t,
            { productTitle: m = null } = t,
            { licenses: b = {} } = t,
            { services: g = {} } = t,
            { paidSupports: y = {} } = t,
            { translations: w = {} } = t,
          ...
          function N(e) {
            ...
            let n;
            t &&
              (o.Z.setProductCartLicense(t),
              (n = p.productCart.services.filter((e) => Z.includes(e))),
              p.productCart.license.items.length &&
                p.productCart.license.items.forEach((e) => {
          ...
          function M(e) {
            if (P) return;
            const t = [
              { typeId: $.Z.WORD_PRESS, serviceId: 13 },
              { typeId: $.Z.WOO_COMERCE, serviceId: 239 },
              { typeId: $.Z.PRESTA_SHOP, serviceId: 74 },
              { typeId: $.Z.SHOPIFY, serviceId: 302 },
              { typeId: $.Z.OPEN_CART, serviceId: 136 },
              { typeId: $.Z.JOOMLA, serviceId: 27 },
              { typeId: $.Z.MOTO_CMS3, serviceId: 333 },
              { typeId: $.Z.MOTOCMS_ECOMMERCE, serviceId: 426 },
              { typeId: $.Z.DRUPAL, serviceId: 30 },
            ];
            let n =
              !e &&
              !s &&
              t.find(
                (e) =>
                  e.typeId === Number(v) &&
                  g.find((t) => Number(t.id) === e.serviceId)
              )?.serviceId;
            const r = (s || e)?.services?.map((e) => e.id);
            r
              ? o.Z.setProductCartServices([
                  ...r,
                  ...(C.enable || !n || r.includes(n) ? [] : [n]),
                ])
              : !C.enable && n && o.Z.setProductCartServices([n]),
              e && (P = !0);
          }
          return (
            (function () {
            ...
            (0, h.H3)(() => {
              !(function () {
                ...
                p.productCart.supports.indexOf(e.id) < 0 &&
                  o.Z.setProductCartSupports([...p.productCart.supports, e.id]);
              })(),
                o.Z.setProductCartProductId(f),
                j &&
                  !C.enable &&
                  (function (e) {
                    ...
                    if (e) {
                      ...
                      (r = [Number(e)].concat((0, O.Z)(r))).length > 10 &&
                        (r = r.slice(0, 10));
                      var o = r.join("-");
                      (0, i.d8)("recentlyViewedProducts", o, { expires: 30 });
                    }
                  })(f);
            }),
            (e.$$set = (e) => {
              "productId" in e && n(4, (f = e.productId)),
                "typeId" in e && n(5, (v = e.typeId)),
                "productTitle" in e && n(6, (m = e.productTitle)),
                "licenses" in e && n(7, (b = e.licenses)),
                "services" in e && n(8, (g = e.services)),
                "paidSupports" in e && n(9, (y = e.paidSupports)),
                "translations" in e && n(0, (w = e.translations)),
                "productGee" in e && n(10, (x = e.productGee)),
                "free" in e && n(11, (C = e.free)),
                "isDefaultPaidSupportOn" in e &&
                  n(12, (S = e.isDefaultPaidSupportOn)),
                "isStateSale" in e && n(13, (j = e.isStateSale));
            }),
            (e.$$.update = () => {
              var t;
              65536 & e.$$.dirty[0] &&
                n(15, (r = (0, _._B)(p.cartModal.total.amount))),
                32768 & e.$$.dirty[0] &&
                  (async function (e) {
                    A = await (0, a.VC)(p);
                  })(),
                65552 & e.$$.dirty[0] &&
                  n(14, (c = p.cart.items.find((e) => e.id === parseInt(f)))),
                65552 & e.$$.dirty[0] &&
                  (s = p.cartModal.items.find((e) => e.id === parseInt(f))),
                16512 & e.$$.dirty[0] &&
                  (u = c ? b.find((e) => e.id === parseInt(c.license)) : {}),
                16384 & e.$$.dirty[0] && M(c),
                65536 & e.$$.dirty[0] &&
                  ((t = p.isSingleCartModalOpen)
                    ? (T = !0)
                    : !t && T && ((T = !1), (P = !1), M(s)));
            }),
            [
              ...
              function () {
                if (
                  (n(1, (E = !0)),
                  (P = !0),
                  o.Z.setIsSingleCartModalOpen(!0),
                  s)
                ) {
                  s.services
                    .filter(
                      (e) => !p.productCart.services.includes(Number(e.id))
                    )
                    .forEach((e) => {
                      (0, I.MM)({
                        link: e.link,
                ...
                (0, k.y)((0, l.c)("openCartPopup", { label: "Add to cart" })),
                  (0, a.Vn)({
                    productId: f,
                    licenseId: C.enable
                      ? null
                      : c
                      ? u?.id
                      : p.productCart.license?.id,
                    servicesIds: p.productCart.services,
                    supportsIds: p.productCart.supports,
                  }).then(() => {
                    p.infoCartModal.recommendedServices[Number(f)]?.length
                      ? (n(1, (E = !1)), (0, a.K4)())
                      : (window.location.href = A);
                  });
                const e = g
                  .filter((e) => p.productCart.services.includes(e.id))
                  .map((e) => e.gee)
                  .filter((e) => e);
                e.length &&
                  e.forEach((e) => {
                    (0, k.y)((0, l.c)("productClick", e)),
                      (0, k.y)((0, l.c)("addToCart", e));
                  });
                const t =
                  y.items &&
                  y.items
                    .filter((e) => p.productCart.supports.includes(e.id))
                    .map((e) => e.gee);
                t?.length &&
                  t.forEach((e) => {
                    (0, k.y)((0, l.c)("productClick", e)),
                ...
                const r = {
                  ...x,
                  licenseId: p.productCart.license
                    ? p.productCart.license.id
                    : "",
                };
        ...
        function D(e) {
          ...
          return {
            c() {
              (t = (0, d.bGB)("button")),
                (n = (0, d.bGB)("span")),
                (0, d.Ljt)(n, "class", "frame-toggler-btn-icon"),
                (0, d.Ljt)(t, "type", "button"),
                (0, d.Ljt)(
                  t,
                  "class",
                  (r =
                    "frame-toggler-btn" +
                    (e[1] ? "" : " frame-toggler-btn_active"))
                ),
                (0, d.Ljt)(t, "title", (o = e[0].label));
            },
            m(r, o) {
              (0, d.$Tr)(r, t, o),
                (0, d.R3I)(t, n),
                a || ((i = (0, d.oLt)(t, "click", e[2])), (a = !0));
            },
            p(e, [n]) {
              2 & n &&
                r !==
                  (r =
                    ...
                    (e[1] ? "" : " frame-toggler-btn_active")) &&
                (0, d.Ljt)(t, "class", r),
                1 & n && o !== (o = e[0].label) && (0, d.Ljt)(t, "title", o);
            },
            i: d.ZTd,
            o: d.ZTd,
            d(e) {
        ...
        function U(e, t, n) {
          ...
          return (
            ...
            [
              ...
              function () {
                i
                  ? (o.classList.add("header_hidden"),
                    a.classList.add("frame_noheader"))
                  : (o.classList.remove("header_hidden"),
                    a.classList.remove("frame_noheader")),
                  n(1, (i = !i));
              },
            ]
          );
        ...
        class V extends d.f_C {
          constructor(e) {
            super(), (0, d.S1n)(this, e, U, D, d.N8, { translations: 0 });
          }
        }
        const B = V;
        function F(e, t) {
        ...
        new M({
          ...
          props: R(
            ...
            {},
            {
              ...
              isDefaultPaidSupportOn: JSON.parse(
                G.getAttribute("data-is-default-paid-support-on")
              ),
        ...
        W &&
          Promise.all([n.e(404), n.e(401), n.e(682)])
            .then(n.bind(n, 9401))
            .then(function (e) {
              new (0,
              e.default)({ target: W, props: R(R({}, W.dataset), {}, { translations: JSON.parse(W.getAttribute("data-translations")) }) });
            }),
          o.Z.subscribe(function (e) {
            if (!z) {
              ...
              t &&
                ((z = !0),
                Promise.all([n.e(404), n.e(312), n.e(278)])
                  .then(n.bind(n, 1740))
                  .then(function (e) {
                    new (0,
                    e.default)({ target: t, props: { cartTranslations: JSON.parse(t.getAttribute("data-cart-translations")) } });
                  }));
            }
          ...
          switch (e) {
            ...
            case "productClick":
              ...
              return {
                event: "productClick",
                ecommerce: {
                  click: { actionField: { list: c }, products: [r] },
                },
              };
            case "useFilter":
              var s = t.filterName,
            ...
            case "addToCart":
              ...
              return {
                event: "addToCart",
                ecommerce: { add: { products: [d] } },
              };
            case "impressionSentOffer":
              return { event: "impressionSent", ecommerce: { impressions: t } };
            ...
            case "promotionView":
              ...
              return {
                event: "promotionView",
                ecommerce: { promoView: { promotions: [O] } },
              };
            case "promotionClick":
              var S = (function (e) {
                var t = e.id,
              ...
              return {
                ...
                ecommerce: { promoClick: { promotions: [S] } },
              };
            case "chatuser":
              var I = t.name,
                _ = void 0 === I ? "" : I,
              ...
              return {
                event: "chatuser",
                userdata: [{ chatname: _, chatroom: j, chatemail: L }],
              };
            case "sorting":
            ...
            case "removeProductFromCart":
              ...
              return (
                ee && (ie = i(i({}, ie), {}, { quantity: ee })),
                {
                  event: "removeFromCart",
                  ecommerce: { remove: { products: [ie] } },
                }
              );
      ...
      3727: (e, t, n) => {
                ...
                return i().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        u.Z.setCartData({ id: t }),
                          fetch(
                            "".concat(s.Z.apiUrls.carts, "/v2/carts/").concat(t)
                          )
                            .then(function (e) {
        ...
        function I() {
          return (I = (0, o.Z)(
            i().mark(function e() {
              var t, n, o, a, c, s, d, l, f, v, h, m, x, C, k, O, S, I, $, j, Z;
              return i().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        ((n = (0, y.DP)(window.location.search)),
                        !(
                          (null === (t = window.location.pathname) ||
                          void 0 === t
                            ? void 0
                            : t.search("/cart/")) >= 0
                        ))
                      ...
                      if (
                        ...
                        (a =
                          n.get("affauthor") ||
                          (0, y.ej)("affauthor") ||
                          null) && (o.affiliateAuthor = a),
                        (c = n.get("aff") || (0, y.ej)("aff") || null) &&
                          (o.affiliate = c),
                        (0, y.ej)("cart_id"))
                      ) {
                        e.next = 16;
                      ...
                      return (e.next = 13), (0, w._R)({ attributes: o });
                    case 13:
                    ...
                    case 16:
                      ...
                      return (
                        ...
                        (v = _(f)),
                        (e.next = 23),
                        (0, p.m3)({ ids: (0, r.Z)(new Set(v)) })
                      );
                    case 23:
                      (h = e.sent) &&
                        h.forEach(function (e) {
                          parseInt(e.onCart, 10)
                            ? d.onCart.push(e.serviceId)
                            : d.onTemplate.push(e.serviceId);
                        });
                    case 25:
                      if (
                        ((m = []),
                        (x = n.get("support")),
                        Boolean(x) && ((C = x.split(",") || []), (m = _(C))),
                        (S = n.get("products")),
                        Boolean(S) &&
                          ((I = (null == S ? void 0 : S.split(",")) || []),
                          (k = _(I)),
                          (O = parseInt(n.get("license")))),
                        ($ = n.get("channel") || "tm2-cart"),
                        !(j = (0, y.ej)("cart_id")))
                      ) {
                        e.next = 35;
                        break;
                      ...
                      return (
                        ...
                        A(j, {
                          ...
                          supportsIds: m,
                          onCartServiceId: d.onCart.length
                            ? d.onCart
                            : !Boolean(S) && d.onTemplate.length
                            ? d.onTemplate
                            : null,
                          onCartSupportId:
                            !Boolean(S) &&
                    ...
                    case 35:
                      Boolean(S) ||
                        Boolean(l) ||
                        Boolean(x) ||
                        Boolean(n.get("cart_id")) ||
                        u.Z.setIsCartModalLoader(!1),
                        (0, b.y)(
                          (0, g.c)("openCartPopup", { label: "Open cart" })
                        );
                    case 37:
                    case "end":
                      return e.stop();
                          ...
                          null === (t = e.support) ||
                            ...
                            t.map(function (t) {
                              ...
                              void 0 === a
                                ...
                                : a.find(function (n) {
                                    return (
                                      n.id === t.id && n.productId === e.id
                                    );
                                  })) || d.push(t.id);
                            });
                        }),
                        null != d && d.length && (0, f.n)({ supportIds: d }),
                        null == s || !s.length)
                      ) {
                        e.next = 15;
                        break;
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        (e.next = 5), (0, d.oc)({ ids: (0, r.Z)(new Set(o)) })
                      );
                    case 5:
                    case "end":
                      return e.stop();
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        (e.next = 5), (0, p.m3)({ ids: (0, r.Z)(new Set(o)) })
                      );
                    case 5:
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (v = n.channel),
                        (m = n.attributes),
                        (b = (0, y.ej)("access_token")),
                        (e.next = 4),
                        fetch(
                          ""
                            .concat(s.Z.apiUrls.carts, "/v2/sockets/token/")
                            .concat(t, "/0"),
                          {
                            method: "POST",
                            headers: { Authorization: b || void 0 },
                          }
                        )
                          .then(function (e) {
                            if (!e.ok) throw new Error();
                    ...
                    case 4:
                      ...
                      return (e.next = 8), (0, w.mO)({ cartId: t });
                    case 8:
                      return (
                        (x = e.sent),
                        (k = x.id),
                    ...
                    case 13:
                      (O = new (C())(
                        "".concat(s.Z.centrifuge, "/connection/websocket"),
                        { refreshAttempts: 0 }
                      )),
                        null != g && g.token && O.setToken(g.token),
                        (S = {
                          publish: function (e) {
                            return (0, o.Z)(
                              i().mark(function t() {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 5:
                        ...
                        return (e.next = 8), (0, w._R)({ attributes: Z });
                      case 8:
                        return (T = e.sent), (P = T.id), (e.next = 12), B(P);
                      case 12:
                        return (
                          (e.next = 14),
                          A(P, {
                      ...
                      case 18:
                        if (
                          ((V =
                            null === (E = L) ||
                            void 0 === E ||
                            null === (N = E.infoCartModal) ||
                            void 0 === N ||
                            null === (M = N.products) ||
                            void 0 === M
                              ? void 0
                              : M.find(function (e) {
                                  return Number(e.templateId) === Number(r);
                                })),
                          (F = [V]),
                          V)
                        ) {
                      ...
                      case 24:
                        if (
                          (null !== (D = L) &&
                            void 0 !== D &&
                            null !== (U = D.infoCartModal) &&
                            void 0 !== U &&
                            U.recommendedServices[Number(r)]) ||
                          !F
                        ) {
                          e.next = 27;
                          break;
                        }
                        return (e.next = 27), (0, p.w0)({ product: F[0] });
                      case 27:
                        (0, f.n)({ templateIds: r });
                      case 28:
                        if (null == g || !g.length) {
                        ...
                        return (
                          (R = g.reduce(function (e, t) {
                            return ""
                              .concat(e, " ")
                              .concat(s.Z.apiUrls.services, "/v1/services/")
                              .concat(t, ",");
                          }, "")),
                          (e.next = 32),
                          (0, w.$U)({
                      ...
                      case 32:
                        ...
                        return (
                          (z = C.reduce(function (e, t) {
                            return ""
                              .concat(e, " ")
                              .concat(s.Z.apiUrls.support, "/v1/support/")
                              .concat(t, ",");
                          }, "")),
                          (e.next = 36),
                          (0, w.$U)({
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        ...
                        (o = n
                          ? s.Z.domain
                          : "".concat(s.Z.domain, "/").concat(s.Z.locale)),
                        (a = [50125, 61529, 50126, 50108, 67280, 50116]),
                        (c = [
                          13, 27, 302, 74, 362, 311, 1740, 115, 239, 515, 1257,
                          1260,
                        ]),
                        (u = window.location.href),
                        localStorage.setItem("page_back", u),
                        !n && !r)
                      ) {
                        e.next = 21;
                        break;
                    ...
                    case 13:
                      ...
                      if (
                        ...
                        1 === (b = t.cartModal.items).length &&
                          b.forEach(function (e) {
                            if ("products" === e.namespace) {
                              var n,
                                r,
                                o = t.infoCartModal.products.find(function (t) {
                              ...
                              a.includes(
                                Number(
                                  null ===
                                    (r = (0, l.cn)(
                                      null == o ? void 0 : o.propertyValues
                                    )) || void 0 === r
                                    ? void 0
                                    : r.id
                                )
                              ) && (m.productsCount += 1),
                                (m.servicesCount = e.services.length
                                  ? e.services.length - i.length
                                  : 0),
                                (m.allowedOffersCount = i.length);
                            }
                            "services" === e.namespace &&
                              (m.servicesCount += 1);
                          }),
      ...
      6573: (e, t, n) => {
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        ...
                        (r = t.type),
                        (o = t.data),
                        (a = void 0 === o ? { license: 0 } : o),
                        (c = t.version),
                        (s = void 0 === c ? "v2" : c),
                        (p = (0, l.ej)("access_token")),
                        (f = (0, l.ej)("cart_id")),
                        (h = ""),
                        (h = Array.isArray(n)
                    ...
                    case 7:
                      return (
                        (m = { productServiceLink: h, cartId: f, itemType: r }),
                        (b = ""),
                        null != a &&
                          a.license &&
                          (b = ""
                            .concat(b, "&data[license]=")
                            .concat(a.license)),
                        null != a &&
                          a.channel &&
                          (b = ""
                            .concat(b, "&data[channel]=")
                            .concat(a.channel)),
                        d.Z.locale &&
                          (b = ""
                            .concat(b, "&data[locale]=")
                            .concat((0, u.Z)(d.Z.locale))),
                        v.Z.setIsProductDataUpdating(!0),
                        (e.next = 15),
                        fetch(
                          ""
                            .concat(d.Z.apiUrls.carts, "/v2/carts/")
                            .concat(f, "/")
                            .concat(r, "?")
                            .concat((0, l.fo)(m))
                            .concat(b),
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (o = t.typeSource),
                        (a = t.itemId),
                        (c = (0, l.ej)("access_token")),
                        (s = (0, l.ej)("cart_id")),
                        (p = "data[channel]=tm2-preview"),
                        d.Z.locale &&
                          (p = ""
                            .concat(p, "&data[locale]=")
                            .concat((0, u.Z)(d.Z.locale))),
                        v.Z.setIsProductDataUpdating(!0),
                        (e.next = 8),
                        fetch(
        ...
        function S(e) {
          ...
          for (var n in e)
            if ("attributes" === n)
              for (var r in e[n])
                t.append("attributes[".concat(r, "]"), e[n][r]);
            else t.append(n, e[n]);
          return t;
        }
        function I(e) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        (o = e.sent),
                        (a = (null == o ? void 0 : o.code) || "USD"),
                        (c = (0, l.ej)("access_token")),
                        (s = (0, l.ej)("aff")),
                        (u = {
                          attributes: m({ affiliate: s }, r),
                          currency: a,
                        }),
                        (f = S(u)),
                        (e.next = 11),
                        fetch("".concat(d.Z.apiUrls.carts, "/v2/carts"), {
                          method: "POST",
                          headers: {
                            "Access-Control-Allow-Origin": "*",
                            Accept: "application/json",
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 5:
                      return (
                        (s = e.sent),
                        (u = (null == s ? void 0 : s.code) || "USD"),
                        (f = (0, l.ej)("access_token")),
                        (v = (0, l.ej)("aff")),
                        (h = {
                          attributes: m({ affiliate: v }, o),
                          currency: u,
                          locale: c,
                        }),
                        (b = S(h)),
                        (e.next = 13),
                        fetch(
                          "".concat(d.Z.apiUrls.carts, "/v2/carts/").concat(n),
                          {
                            method: "PUT",
                            headers: {
                              "Access-Control-Allow-Origin": "*",
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        ...
                        (e.next = 9),
                        fetch(
                          "".concat(d.Z.apiUrls.carts, "/v2/carts/").concat(a),
                          {
                            method: "COPY",
                            headers: {
                              "Content-Type":
                    ...
                    case 14:
                      return (
                        (y = e.sent),
                        v.Z.setCartData({ id: y.id }),
                        v.Z.setCartModalData({ id: y.id }),
                        (e.next = 19),
                        (0, f.Mz)(y.id)
                      );
                    case 19:
      ...
      3081: (e, t, n) => {
        ...
        function p() {
          var e,
            ...
            n = [].concat(d);
          !0 === t && n.push(l),
            (e = document.querySelector("body").classList).add.apply(
              e,
              (0, a.Z)(n)
            );
        }
        function f() {
          var e;
          (e = document.querySelector("body").classList).remove.apply(
            e,
            d.concat([l])
          );
        }
        ...
        function h(e) {
          for (
            var t = new URLSearchParams(), n = 0, r = Object.entries(e);
            n < r.length;
            n++
          ) {
            var a = (0, o.Z)(r[n], 2),
        ...
        function y(e, t) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2]
                ? arguments[2]
                : {},
            r = u({ expires: 14, domain: c.Z.cookieDomain }, n);
          i.Z.set(e, t, r);
        }
        function w() {
      ...
      7952: (e, t, n) => {
        ...
        document.querySelectorAll("[data-plasma-icon]").forEach(function (e) {
      ...
      9661: (e, t, n) => {
        ...
        class s extends r.f_C {
          constructor(e) {
            super(), (0, r.S1n)(this, e, c, i, r.N8, { className: 1, src: 2 });
          }
        }
        const u = s;
      },
      5185: (e, t, n) => {
          ...
          return {
            c() {
              (t = (0, r.bGB)("span")),
                ...
                (i = (0, r.DhX)()),
                (c = (0, r.bGB)("span")),
                (0, r.Ljt)(n, "class", "TMLoader__line svelte-1alvb7h"),
                (0, r.Ljt)(a, "class", "TMLoader__line svelte-1alvb7h"),
                (0, r.Ljt)(c, "class", "TMLoader__line svelte-1alvb7h"),
                (0, r.Ljt)(
                  t,
                  "class",
                  (s =
                    "TMLoader TMLoader--width-" +
                    e[0] +
                    " TMLoader--height-" +
                    e[1] +
                    " svelte-1alvb7h")
        ...
        class i extends r.f_C {
          constructor(e) {
            super(), (0, r.S1n)(this, e, a, o, r.N8, { width: 0, height: 1 });
          }
        }
        const c = i;
      },
      ...
      4234: (e, t, n) => {
        ...
        function P(e, t, { bubbles: n = !1, cancelable: r = !1 } = {}) {
  ...
  (i.m = o),
    ...
    (i.O = (t, n, r, o) => {
      if (!n) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [n, r, o] = e[d], c = !0, s = 0; s < n.length; s++)
    ...
    (i.u = (e) =>
      ...
      "-" +
      {
        ...
        278: "e275b43377470e380586",
        312: "38b39db9fb8feb9acac8",
        401: "8e7002fb2ac73e612491",
        404: "0318df611ffc06464d4f",
        682: "fe7ede3de0bb91465317",
      }[e] +
      ".js"),
    (i.miniCssF = (e) => "css/" + e + "-5732820b1c138762b160.css"),
    (i.g = (function () {
